...
// create task service
export const createTaskServices = async (workspaceId: string, projectId: string, userId: string,
    body: {
        title: string;
        description?: string;
        priority: string;
...
// update task service
export const updateTaskService = async (workspaceId: string, projectId: string, taskId: string,
    body: {
        title: string;
        description?: string;
        priority: string;
...
export const getAllTasksServices = async (workspaceId: string,
    filters: {
        projectId?: string;
        status?: string[];
        priority?: string[];
...
// single task service
export const getTaskByIdServices = async (workspaceId: string, projectId: string, taskId: string) => {
    const project = await ProjectModel.findById(projectId);
    if (!project || project.workspace.toString() !== workspaceId.toString()) {
...
export const deleteTaskServices = async (workspaceId: string, taskId: string) => {
